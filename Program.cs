...
for (int i = 0; i < maxPets; i++)
{
    ...
    // If the suggestedDonation variable can't be cast as a decimal the code assigns a default value decimalDonation = 45.00m;
    ...
    switch (menuSelection)
    {
        ...
        case "4":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                // checking Personality description
        ...
        case "8":
            ...
            {
                // force the user to enter physical characteristics to search for
